                ...
                if (listRecipt[i].id_kh == listUser[j].id){
                    if(listRecipt[i].tinhtrang==="Chưa nhận hàng"){
                        ...
                        <tr>
                            ...
                            <td class="d-none d-xl-table-cell">27/11/2022</td>
                            <td class="d-none d-xl-table-cell">${listUser[j].Address}</td>
                            <td><span class="badge bg-danger">${listRecipt[i].tinhtrang}</span></td>
                            <td><button onclick="detailRecipt(this)" id-recipt='${listRecipt[i].id}' class="btn btn-info">Chi tiết</button> <button onclick="editRecipt()" class="btn btn-primary">Sửa</button> <button onclick="deleteRecipt(this)" id-recipt = "${listRecipt[i].id}" class="btn btn-danger">Xóa</button></td>
                        </tr>
                    `
...
detailRecipt = (recipt) => {
    ...
    console.log(textHTLM)
    document.getElementById('body').innerHTML=textHTLM
}
